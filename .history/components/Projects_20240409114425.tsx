...
function Projects({}: Props) {
  ...
  return (
    ...
    mx-auto items-center z-0'>
        ...
        snap-x snap-mandatory z-0 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#778A35]/80'>
            {projects.map((projects:any, i) => (
                // eslint-disable-next-line react/jsx-key
                <div className='w-screen flex-shrink-0 snap-center flex flex-col  space-y-5
                items-center justify-center p-20 md:p-44 h-screen'>
                    <div className='flex flex-row justify-center items-center ' >
                    <ArrowLeftIcon className="flex-shrink-0  flex flex-row  space-y-5
                items-center justify-center   h-5 w-5 text-white-700 opacity-70" />
                    ...
                    />
                    <ArrowRightIcon className="flex-shrink-0 flex flex-row  space-y-5
                items-center justify-center   h-5 w-5 text-white-700 opacity-70" />
        ...
        <div className=' w-full absolute top-[20%] bg-[#778A35]/10 left-0
        h-[500px] -skew-y-12'/>
    </motion.div>
  )
}
